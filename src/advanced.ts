    ...
    try {
      ...
      setStatus(
        ...
        data.backend + ": " + (data.available ? "available" : "unavailable") +
          " · policy " + data.mode + (data.version ? " · " + data.version : ""),
